...
#KNI - Data
KNI_groups <- list(avg_div, avg_ubiq) %>% reduce(merge, by= c("nuts"))
colnames(KNI_groups) <- c("Region", "Average diversity", "Average ubiquity")
str(KNI_groups)
KNI_groups[2:3] <- lapply(KNI_groups[2:3], as.numeric)


#KNI - Quadrants 
x_mid <- mean(c(max(KNI_groups$`Average ubiquity`, na.rm = TRUE), 
                min(KNI_groups$`Average ubiquity`, na.rm = TRUE)))

y_mid <- mean(c(max(KNI_groups$`Average diversity`, na.rm = TRUE), 
                min(KNI_groups$`Average diversity`, na.rm = TRUE)))

KNIplot <- KNI_groups %>% 
  mutate(Quadrant = case_when(KNI_groups$`Average ubiquity` > x_mid & KNI_groups$`Average diversity` > y_mid   ~ "High diversity and high ubiquity",
                              KNI_groups$`Average ubiquity` <= x_mid & KNI_groups$`Average diversity` > y_mid  ~ "High diversity and low ubiquity",
                              KNI_groups$`Average ubiquity` <= x_mid & KNI_groups$`Average diversity` <= y_mid ~ "Low diversity and low ubiquity",
                              TRUE                                         ~ "Low diversity and high ubiquity")) %>% 
  ggplot(aes(x = KNI_groups$`Average ubiquity`, y = KNI_groups$`Average diversity`, color = Quadrant)) +
  geom_vline(xintercept = x_mid, col = "gray", size = 0.1) + # plot vertical line
  geom_hline(yintercept = y_mid, col = "gray",size = 0.1) + # plot horizontal line
  geom_point()  + scale_color_manual(values = c('black', 'blue4', 'steelblue2', 'gray')) + 
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  labs (title = "Average diversity and ubiquity of EU regions 
        in Solar PV technology (2000-2009)", 
        y  = "Average diversity", x = "Average ubiquity", element_text(colour = "gray"))+
  ...
  geom_text(label = KNI_groups$Region, size = 2.5, check_overlap = T, nudge_y = 0.5) +
  guides(color = FALSE)
...
KNIplot0 <-  ggplot(KNI_groups, aes(x = KNI_groups$`Average ubiquity`, y = KNI_groups$`Average diversity`))+ 
                           geom_point(color = "gray28", size = 0.8)  + 
  geom_smooth(method = lm, se = F, size = 0.2, color ="blue4" ) + 
                           theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  labs (title = "Average diversity and ubiquity of EU regions 
        in Solar PV technology (2000-2009)", 
        y  = "Average diversity", x = "Average ubiquity", element_text(colour = "gray"))+
  theme(axis.title = element_text(size = 10, colour = 'gray32', hjust =0.5)) + 
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5)) +
  geom_text(label = KNI_groups$Region, size = 2.5, check_overlap = T, nudge_y = 0.5, colour = "gray28")
...
png(file = "Quadrants_PV1.png")
KNIplot
dev.off()


setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Plots")
png(file = "KNI_PV1.png")
KNIplot0
dev.off()
...
#Choose variable
TECH <- TECH_DATA[,c(1,2)]

#Join variable
mapdataTECH <- left_join(mapdata, TECH, by = "Region")                          # use left_join to match the data sets. 

# Create categories
mapdataTECH$KNI <- as.numeric(mapdataTECH$KNI)
mapdataTECH <- mutate(mapdataTECH, cat = cut_to_classes(KNI, n = 4, style = "quantile", decimals = 2))

map <- ggplot(mapdataTECH, aes(x = long, y = lat, group = group)) +                    
  geom_polygon(aes(fill = cat), color="grey", size = .1) +                    
  scale_fill_brewer(palette = "YlOrRd") +                                    
  labs(title = "Knowlede complexity score of EU regions 
       in Solar PV technology (2010-2019)",                 
       fill = "Score") + 
  coord_map(xlim = c(-22,33), ylim = c(28,71))+
  theme(axis.title = element_text(size = 10, colour = 'gray32', hjust =0.5)) + 
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_1 <- read.table("PV_1.txt", sep = "")
...
plot_1 <- ggplot(DATA_1,aes( x= DATA_1$KNI)) + 
  geom_histogram(color = "gray90" , fill = "yellow2", breaks = breaks) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Knowledge complexity index (KNI) (2000-2009)") + ylab ("Frequency") +
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_2 <- read.table("PV_2.txt", sep = "")
...
plot_2 <- ggplot(DATA_2,aes( x= DATA_2$KNI)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Knowledge complexity index (KNI) (2010-2019)") + ylab ("Frequency") +
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_3 <- read.table("PV_1.txt", sep = "")
...
plot_3 <- ggplot(DATA_3,aes( x= DATA_3$RD)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Relatedness density (RD) (2000-2009)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,1,0,0),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_4 <- read.table("PV_2.txt", sep = "")
...
plot_4 <- ggplot(DATA_4,aes( x= DATA_4$RD)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Relatedness density (RD) (2010-2019)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,0,0,1),"cm"))
...
plot_5 <- ggplot(DATA_5,aes( x= DATA_5$K)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Knowledge accumulated (K) (2000-2009)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,1,0,0),"cm"))
...
plot_6 <- ggplot(DATA_6,aes( x= DATA_6$K)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Knowledge accumulated (K) (2010-2019)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,0,0,1),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_7 <- read.table("PV_1.txt", sep = "")
...
plot_7 <- ggplot(DATA_7,aes( x= DATA_7$C)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Electricity from fossil fuels (C) (2000-2009)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,1,0,0),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_8 <- read.table("PV_2.txt", sep = "")
...
plot_8 <- ggplot(DATA_8,aes( x= DATA_8$C)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Electricity from fossil fuels (C) (2010-2019)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,0,0,1),"cm"))


setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Plots")
png("PV_1.png", width = 800, height = 1100)
grid.arrange(plot_1, plot_2, plot_3, plot_4, plot_5, plot_6, plot_7, plot_8, ncol = 2, nrow = 4)
dev.off()
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_9 <- read.table("PV_1.txt", sep = "")
...
plot_9 <- ggplot(DATA_9,aes( x= DATA_9$CL)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Complementary interregional linkages (CL) (2000-2009)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,1,0,0),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_10 <- read.table("PV_2.txt", sep = "")
...
plot_10 <- ggplot(DATA_10,aes( x= DATA_10$CL)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Complementary interregional linkages (CL) (2010-2019)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,0,0,1),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_11 <- read.table("PV_1.txt", sep = "")
...
plot_11 <- ggplot(DATA_11,aes( x= DATA_11$GDP)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Gross domestic product per capita (GDP) (2000-2009)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,1,0,0),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_12 <- read.table("PV_2.txt", sep = "")
...
plot_12 <- ggplot(DATA_12,aes( x= DATA_12$GDP)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Gross domestic product per capita (GDP) (2010-2019)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,0,0,1),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_13 <- read.table("PV_1.txt", sep = "")
...
plot_13 <- ggplot(DATA_13,aes( x= DATA_13$P)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Population (P) (2000-2009)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,1,0,0),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_14 <- read.table("PV_2.txt", sep = "")
...
plot_14 <- ggplot(DATA_14,aes( x= DATA_14$P)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Population (P) (2010-2019)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,0,0,1),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_15 <- read.table("PV_1.txt", sep = "")
...
plot_15 <- ggplot(DATA_15,aes( x= DATA_15$M)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Installed capacity (M) of analysed technology (2000-2009)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,1,0,0),"cm"))
...
# Load data
setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Regression")
DATA_16 <- read.table("PV_2.txt", sep = "")
...
plot_16 <- ggplot(DATA_16,aes( x= DATA_16$M)) + 
  ...
  theme(plot.title = element_text(size = 12, colour = 'gray28', hjust = 0.5))+
  theme_few() + theme(panel.border = element_rect(colour = "gray")) +
  xlab ("Installed capacity (M) of analysed technology (2010-2019)") + ylab ("Frequency") +
  theme(plot.margin=unit(c(1.5,0,0,1),"cm"))



setwd("~/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/MSc Innovation Sciences/Thesis/Data analysis/Plots")
png("PV_2.png", width = 800, height = 1100)
