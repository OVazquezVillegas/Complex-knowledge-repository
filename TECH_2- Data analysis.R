...
CARBON <- read.delim("CARBON_2_share.txt", sep = "")
...
inter <- read.delim("PV_2.txt", sep = "", header = T)
...
DEPLOYMENT <- read.delim("PV_2.txt", sep = "")
...
write.table(TECH_DATA, "PV_2.txt")
