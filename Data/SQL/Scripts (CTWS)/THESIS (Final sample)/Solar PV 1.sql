...
SELECT cluster_id1, weight, perc_cluster = (weight /52210.00) * 100.0
INTO #cluster_perc
...
SELECT DISTINCT a.cluster_id1, a.weight, perc_cluster = (a.weight /52210.00) * 100.0
