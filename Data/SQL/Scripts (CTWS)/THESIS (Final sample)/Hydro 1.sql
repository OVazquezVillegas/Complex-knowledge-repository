...
where b.cpc_class_symbol = 'Y02E  10/20'
...
/* 5.1 Select publication years and geographical scope (European regions, 2000-2009) */ 
...
WHERE a.pub_year between 2000 and 2009 and left(e.[nuts_level3_code],4) != 'NULL'
...
SELECT b.sublabel AS label,  a.weight AS sublabel, b.description, b.x, b.y, b.cluster, a.weight
INTO mapfile_3
