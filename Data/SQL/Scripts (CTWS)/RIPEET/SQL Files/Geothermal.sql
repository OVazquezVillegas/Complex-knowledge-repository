...
where b.cpc_class_symbol LIKE 'Y02E  10/10'
...
/* 5.1 Select publication years and geographical scope (European regions, 2015-2019) */ 
...
/* 7 SELECTING FINAL SAMPLE OF PUBLICATIONS (UNQUE) */ 
...
/* 7.2 Counting uts per nuts2 (this is the database used to cluster regions)*/ 
...
/* 7.3 Calculate the number of unique regional units (NUTS2) of the sample*/ 
