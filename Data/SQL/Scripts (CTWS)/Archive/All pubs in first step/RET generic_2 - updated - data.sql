...
select distinct  a.ut, cluster_id1
...
SELECT h.nuts_level3_code, a.cluster_id1, a.ut
INTO #nuts
...
SELECT nuts_level3_code, cluster_id1
INTO #nuts3
FROM #nuts

SELECT*
FROM #nuts3 ORDER BY nuts_level3_code

SELECT nuts_level3_code, cluster_id1, counts = count( cluster_id1)
FROM #nuts3
GROUP BY cluster_id1, nuts_level3_code ORDER BY nuts_level3_code DESC

 /**/
SELECT cluster_id1, pubs = COUNT(cluster_id1)
FROM #nuts
GROUP BY cluster_id1 ORDER BY pubs DESC

SELECT nuts_level3_code, pubs = COUNT(nuts_level3_code)
FROM #nuts
GROUP BY nuts_level3_code ORDER BY pubs DESC
