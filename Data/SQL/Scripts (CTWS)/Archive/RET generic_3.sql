...
INTO tech
  ...
  where b.cpc_class_symbol LIKE 'Y02E  10/7%' and i.pub_year between 2009 and 2018 and left(h.[nuts_level3_code],4) != 'NULL'
...
where a.pub_year between 2009 and 2018 and left(e.[nuts_level3_code],4) != 'NULL'
...
where b.pub_year between 2009 and 2018
group by cluster_id1
