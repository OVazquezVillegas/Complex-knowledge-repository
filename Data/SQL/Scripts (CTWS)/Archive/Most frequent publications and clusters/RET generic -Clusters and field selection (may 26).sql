...
SELECT cluster_id1, weight, perc_cluster = (weight /274.00) * 100.0
INTO #cluster_perc
...
SELECT COUNT (*) FROM #cluster_selected_ut
...
SELECT COUNT (*) FROM #sample_expanded_eu
/*TEST*/



SELECT COUNT (*) FROM  #cluster_sample_expanded_eu
...
DROP TABLE IF EXISTS #tech_cluster_filtered_counts
SELECT ut, freq = count(ut)
INTO #tech_cluster_filtered_counts
...
SELECT SUM (weight) FROM #cluster_selected_final
